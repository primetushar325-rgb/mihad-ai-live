...
// The channel belonging to whoever just granted OAuth consent (used right
// after the connect flow to find out which channel was authorized).
export async function fetchMyChannel(accessToken) {
  const url = `${YT_DATA_BASE}/channels?part=snippet,statistics&mine=true`
